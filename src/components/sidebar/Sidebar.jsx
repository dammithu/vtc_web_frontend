...
function Sidebar() {
  ...
  const lecturerMenuItems = [
    ...
    { icon: User, label: "Profile", path: "/lecturerprofile" },
  ...
  return (
    <>
      ...
      >
        ...
        >
          <X
            className={`w-6 h-6 ${isDarkMode ? "text-gray-400" : "text-blue-600"}`}
          />
        </button>

        {/* Logo Section */}
        <div
          className={`p-6 flex items-center justify-center border-b ${isDarkMode ? "border-gray-800" : "border-blue-200"}`}
        >
          <img
            src={vtclogo}
            alt="VTC Logo"
        ...
        {!loading && (
          <div
            className={`px-4 py-2 mx-4 mt-2 rounded-lg text-center
